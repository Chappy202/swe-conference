...
- [ ] 1. Set up project foundation and shared types
  - [ ] 1.1 Install react-router-dom and create shared type definitions
  ...
  - [ ] 1.2 Implement formatting utilities with tests
...
- [ ] 2. Implement badge components
  - [ ] 2.1 Implement StatusBadge component with tests
  ...
  - [ ] 2.2 Implement PriorityBadge component with tests
  ...
  - [ ]* 2.3 Write property tests for badge components
...
- [ ] 3. Implement filter and sort controls
  - [ ] 3.1 Implement FilterBar component with tests
  ...
  - [ ] 3.2 Implement SortControls component with tests
...
- [ ] 4. Implement data hook and table components
  - [ ] 4.1 Implement useDisputes custom hook with tests
  ...
  - [ ]* 4.2 Write property test for API query parameter serialization
  ...
  - [ ] 4.3 Implement DisputeRow component with tests
  ...
  - [ ]* 4.4 Write property test for row data integrity
...
- [ ] 6. Implement table container and dashboard page
  - [ ] 6.1 Implement DisputesTable component with tests
  ...
  - [ ] 6.2 Implement Dashboard page component with tests
  ...
  - [ ]* 6.3 Write property tests for filter accuracy and sort correctness
...
- [ ] 7. Wire routing and final integration
  - [ ] 7.1 Update App.tsx with react-router-dom routing
