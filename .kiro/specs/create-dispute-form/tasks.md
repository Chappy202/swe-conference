...
- [x] 1. Core types and validation utilities
  - [x] 1.1 Create shared type definitions for the dispute form
  ...
  - [x] 1.2 Implement pure validation functions
  ...
  - [x]* 1.3 Write unit tests for validation functions
  ...
  - [x]* 1.4 Write property test for invalid amount validation
...
- [x] 2. Customer data hook
  - [x] 2.1 Implement useCustomers hook
  ...
  - [x]* 2.2 Write unit tests for useCustomers hook
...
- [x] 3. Presentational components
  - [x] 3.1 Create CustomerSelect component
  ...
  - [x] 3.2 Create TransactionEntryGroup component
  ...
  - [x]* 3.3 Write property test for customer dropdown format consistency
  ...
  - [x]* 3.4 Write property test for transaction group field completeness
...
- [x] 5. CreateDisputePage — form assembly and state management
  - [x] 5.1 Implement CreateDisputePage with rendering and state management
  ...
  - [x] 5.2 Implement form submission, API call, and navigation
  ...
  - [x]* 5.3 Write property test for adding transaction grows list
  ...
  - [x]* 5.4 Write property test for transaction count minimum invariant
  ...
  - [x]* 5.5 Write property test for submit enabled iff form valid
  ...
  - [x]* 5.6 Write property test for blur triggers validation feedback
  ...
  - [x]* 5.7 Write property test for submission payload shape
  ...
  - [x]* 5.8 Write property test for total amount equals sum
  ...
  - [x]* 5.9 Write property test for success redirect
  ...
  - [x]* 5.10 Write property test for error message propagation
...
- [x] 6. Route integration
  - [x] 6.1 Wire CreateDisputePage into App.tsx routing
